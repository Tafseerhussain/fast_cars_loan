   ...
   <div class="row">
      ...
      <div class="col-md-8">
         <form wire:submit.prevent="submit">
            ...
            <div class="form-group">
               <label for="sectionButtonOne">Section Button One</label>
               <input type="text" class="form-control" wire:model.defer="sectionButtonOne" placeholder="Hero Button">
               @error('sectionButtonOne') <span class="input_error">{{ $message }}</span> @enderror
            </div>
            <div class="form-group">
               <label for="sectionButtonTwo">Section Button Two</label>
               <input type="text" class="form-control" wire:model.defer="sectionButtonTwo" placeholder="Hero Button">
               @error('sectionButtonTwo') <span class="input_error">{{ $message }}</span> @enderror
            </div>
