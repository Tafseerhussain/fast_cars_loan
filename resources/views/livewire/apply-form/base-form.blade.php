        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="first_name" placeholder="Mick" wire:model="firstName">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="last_name" placeholder="John" wire:model="lastName">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="last_name" placeholder="John" wire:model="email">
            ...
            <div class="col-md-12">
                <div class="form-group row">
                    ...
                    <div class="col-5">
                        <input type="text" class="form-control" name="code" placeholder="code" wire:model="mobileCode">
                        @error('mobileCode') <span class="input_error">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-7">
                        <input type="text" class="form-control" name="number" placeholder="number" wire:model="mobileNumber">
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="income" placeholder="500" wire:model="income">
            ...
            <div class="col-md-7">
                <div class="form-group">
                    ...
                    @endphp
                    <select class="form-select form-control" name="credit_score" wire:model="creditScores">
            ...
            <div class="col-12">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" wire:model="agree">
            ...
            <div class="col-12">
                <button type="submit" class="btn mt-2" wire:>Send</button>
            </div>
        </div>
    </form>
</div>
