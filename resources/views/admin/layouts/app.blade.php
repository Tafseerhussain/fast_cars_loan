...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Request::route()->getName() == 'admin.clients' ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.clients') }}">
                    <img src="{{ asset('img/admin/icons/clients.svg') }}" alt="clients">
                    <span>Clients</span>
                </a>
            </li>
            ...
            {{-- <li class="nav-item">
                <a class="nav-link" href="index.html">
                    <img src="{{ asset('img/admin/icons/loans.svg') }}" alt="loans">
            ...
            {{ 
                (
                    ...
                    Request::route()->getName() == 'admin.advantage.customize'
                ) 
                 ? 'active' : '' 
             }}">
                <a class="nav-link 
                ...
                {{ 
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item 
                        {{ Request::route()->getName() == 'admin.advantage.customize' ? 'active' : '' }}" 
                        href="{{ route('admin.advantage.customize') }}">
                            Advantages
                        </a>
                    </div>
                </div>
